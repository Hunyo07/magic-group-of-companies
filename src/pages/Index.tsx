    ...
    <div>
      ...
      <div data-aos="zoom-in" className="flex flex-col">
        ...
        <section
          ...
          // className="relative flex min-h-[60vh] items-center justify-center bg-gradient-to-r from-purple-600 to-blue-600 text-white"
          className="relative flex min-h-[60vh] items-center justify-center bg-blue-600 text-white"
        >
          ...
          <div className="container">
            <div data-aos="fade-up" className="grid gap-8 md:grid-cols-2">
              <Card style={{ backgroundColor: activeTheme.primaryColor }}>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    To provide quality products and exceptional service to our
                    customers while contributing to the growth and development
                    of our communities.
                  </p>
                </CardContent>
              </Card>
              <Card style={{ backgroundColor: activeTheme.primaryColor }}>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    To be the leading retail group in the region, known for
          ...
          <div data-aos="fade-up" className="container">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              <Card style={{ backgroundColor: activeTheme.primaryColor }}>
                <CardHeader>
                  ...
                  <CardDescription>
                    Enjoy exciting discounts and loyalty rewards designed to
              ...
              <Card style={{ backgroundColor: activeTheme.primaryColor }}>
                <CardHeader>
                  ...
                  <CardDescription>
                    We're committed to serving local communities with accessible
                    locations, ethical practices, and programs that give back.
                  </CardDescription>
                </CardHeader>
                <CardContent className="text-sm text-muted-foreground">
                  <p>
                    CSR initiatives, partnerships with local farmers and
                    suppliers, and community outreach programs.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card style={{ backgroundColor: activeTheme.primaryColor }}>
                <CardHeader>
                  ...
                  <CardDescription>
                    With multiple branches across Pangasinan and nearby
                    provinces, shopping with us is always within your reach.
                  </CardDescription>
                </CardHeader>
                <CardContent className="text-sm text-muted-foreground">
                  <ul className="list-inside list-disc space-y-1">
              ...
              <Card style={{ backgroundColor: activeTheme.primaryColor }}>
                <CardHeader>
                  ...
                  <CardDescription>
                    ...
                    assistance and innovative services to enhance your shopping
                    experience.
                  </CardDescription>
                </CardHeader>
                <CardContent className=" text-sm text-muted-foreground">
                  <ul className="list-inside list-disc space-y-1">
                    ...
                    <li>
                      Flexible payment methods, including digital payments
                    </li>
            ...
            <div data-aos="fade-up" className="mt-12 text-center">
              <p className="mb-6 text-lg">
                Visit your nearest Magic store today and experience the
                difference!
              </p>
            </div>
          </div>
        ...
        >
          <div data-aos="fade-up" className="container text-center">
            ...
            <p className="mx-auto mb-8 max-w-2xl">
              ...
              family. Discover exciting career opportunities with us.
            </p>
            <Button
              style={{ backgroundColor: activeTheme.secondaryColor }}
              size="lg"
