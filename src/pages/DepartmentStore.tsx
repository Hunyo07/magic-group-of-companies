  ...
  return (
    <div className="container py-8">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <Card>
          <CardContent className="p-6">
            ...
            <p className="text-gray-600">
              Transform your living space with our extensive collection of home furnishings,
              decor, and household essentials. Find everything you need to make your house a home.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-6">
            ...
            <p className="text-gray-600">
              Discover the latest trends in fashion, accessories, and beauty products.
              Our carefully curated collections cater to every style and occasion.
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="bg-gray-50 p-8 rounded-lg">
        <h2 className="text-3xl font-semibold mb-4">Department Store Features</h2>
